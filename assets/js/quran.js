...
const juzData = [
  {juz:1,start:1,end:21,label:'الم'},
  {juz:2,start:22,end:41,label:'سيقول السفهاء'},
  {juz:3,start:42,end:61,label:'تلك الرسل'},
  {juz:4,start:62,end:81,label:'لن تنالوا البر'},
  {juz:5,start:82,end:101,label:'والمحصنات'},
  {juz:6,start:102,end:121,label:'لا يحب الله'},
  {juz:7,start:122,end:141,label:'وإذا سمعوا'},
  {juz:8,start:142,end:161,label:'ولو أننا'},
  {juz:9,start:162,end:181,label:'قال الملأ'},
  {juz:10,start:182,end:201,label:'واعلموا'},
  {juz:11,start:202,end:221,label:'يعتذرون إليكم'},
  {juz:12,start:222,end:241,label:'وما من دابة'},
  {juz:13,start:242,end:261,label:'وما أبرئ نفسي'},
  {juz:14,start:262,end:281,label:'ربما'},
  {juz:15,start:282,end:301,label:'سبحان الذي'},
  {juz:16,start:302,end:321,label:'قال ألم'},
  {juz:17,start:322,end:341,label:'اقترب للناس'},
  {juz:18,start:342,end:361,label:'قد أفلح'},
  {juz:19,start:362,end:381,label:'وقال الذين لا يرجون'},
  {juz:20,start:382,end:401,label:'أمن خلق'},
  {juz:21,start:402,end:421,label:'اتل ما أوحي'},
  {juz:22,start:422,end:441,label:'ومن يقنت'},
  {juz:23,start:442,end:461,label:'وما لي'},
  {juz:24,start:462,end:481,label:'فمن أظلم'},
  {juz:25,start:482,end:501,label:'إليه يرد'},
  {juz:26,start:502,end:521,label:'حم'},
  {juz:27,start:522,end:541,label:'قال فما خطبكم'},
  {juz:28,start:542,end:561,label:'قد سمع الله'},
  {juz:29,start:562,end:581,label:'تبارك الذي'},
  {juz:30,start:582,end:604,label:'عم يتساءلون'}
];
...
function renderJuzIndex(){
  ...
  wrap.innerHTML = juzData.map(item => `
    <button class="juz-card" data-juz="${item.juz}">
      ...
      <div class="juz-range">من الصفحة ${item.start} إلى ${item.end}</div>
    </button>
  `).join('');
